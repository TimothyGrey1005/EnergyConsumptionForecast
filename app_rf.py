...
# Streamlit App Title
st.title('Real-Time Energy Monitoring Dashboard with Random Forest')
...
st.subheader('Random Forest Predictions vs Actual Values')
plt.figure(figsize=(12, 6))
plt.plot(y_test.reset_index(drop=True), label='Actual Values', color='blue')
plt.plot(y_pred_rf, label='Predicted Values', color='orange', linestyle='dashed')
